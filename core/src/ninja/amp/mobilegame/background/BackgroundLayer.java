...
public class BackgroundLayer implements Background {
    ...
    public BackgroundLayer(TextureRegion texture, Vector2 ratio, Vector2 offset, TileMode mode) {
    ...
    public BackgroundLayer(TextureRegion texture, Vector2 ratio, Vector2 offset) {
        this(texture, ratio, offset, TileMode.SINGLE);
    }

    public BackgroundLayer(TextureRegion texture, Vector2 ratio, TileMode mode) {
        this(texture, ratio, Vector2.Zero, mode);
    }

    public BackgroundLayer(TextureRegion texture, TileMode mode) {
        this(texture, Vector2.Zero, Vector2.Zero, mode);
    }

    public BackgroundLayer(TextureRegion texture, Vector2 ratio) {
        this(texture, ratio, Vector2.Zero, TileMode.SINGLE);
    }

    public BackgroundLayer(TextureRegion texture) {
