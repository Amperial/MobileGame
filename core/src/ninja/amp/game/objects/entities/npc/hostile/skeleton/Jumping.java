...
public class Jumping implements Pose {
    ...
    public Jumping(final Body body) {
        ...
        Position arm_left_upper = new TreePosition(torso, 0.25f, 5f / 8f, 1f / 16f, 1f / 16f, 1f / 8f, 7f / 16f, 135f) {//105f
            @Override
        ...
        positions.put("arm_left_lower", new TreePosition(arm_left_upper, 0, 6f / 16f, 1f / 16f, 0, 1f / 8f, 7f / 16f, 15f) {//15f
            @Override
            public float getRotation() {
        ...
        Position arm_right_upper = new TreePosition(torso, 0.25f, 5f / 8f, 1f / 16f, 1f / 16f, 1f / 8f, 7f / 16f, 225f) {//255f
            @Override
            public float getRotation() {
                return super.getRotation() + body.getPoseTime() * 60;
            }
        ...
        positions.put("arm_right_lower", new TreePosition(arm_right_upper, 0, 6f / 16f, 1f / 16f, 0, 1f / 8f, 7f / 16f, 15f) {//-15f
            @Override
            public float getRotation() {
                return super.getRotation() + body.getPoseTime() * 10;
            }
        ...
        Position leg_left_upper = new TreePosition(torso, 0.25f, 3f / 16f, 1f / 16f, 8f / 16f, 1f / 8f, 7f / 16f, 45f) {//45, forward
            @Override
            public float getRotation() {
                return super.getRotation() + body.getPoseTime() * 10;
            }
        ...
        positions.put("leg_left_lower", new TreePosition(leg_left_upper, 0, -7f / 16f, 1f / 16f, 8f / 16f, 1f / 8f, 7f / 16f, -30f) {
            @Override
            public float getRotation() {
                return super.getRotation() - body.getPoseTime() * 10;
            }
        ...
        Position leg_right_upper = new TreePosition(torso, 0.25f, 3f / 16f, 1f / 16f, 8f / 16f, 1f / 8f, 7f / 16f, -20f) {//-30, back
            @Override
            public float getRotation() {
                return super.getRotation() - body.getPoseTime() * 10;
            }
        ...
        positions.put("leg_right_lower", new TreePosition(leg_right_upper, 0, -7f / 16f, 1f / 16f, 8f / 16f, 1f / 8f, 7f / 16f, -15f) {
            @Override
            public float getRotation() {
                return super.getRotation() - body.getPoseTime() * 10;
            }
